...
class LinkedList(object):
    ...
    def print_list(self):
        ...
        # continue to print each node's data until current node is None
        while current:
    ...
    def get_node_by_index(self, idx):
        ...
        #continue to iterate through nodes idx number of times
        while count < idx:

            # if answer.next causes error due to answer being NoneType
