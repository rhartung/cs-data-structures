...
class Tree(object):
    ...
    def breadth_first_search(self, data):
        ...
        # almost same as depth first search
        # instead of checking last item in list, will check first item
        # this way loop will check each child of the root first, then each
        # child of the children of the root, etc. until it finds desired data.
